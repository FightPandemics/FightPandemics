  ...
  return (
    <>
      <Paragraph>
        ...
        this website and hereby informs YOU how We will collect and process your
        Personal Data (as defined below) when YOU use our services, websites and
        applications (the <strong>"Services"</strong>).
      </Paragraph>
      <Paragraph>
        By using the Services, YOU consent that we can collect and process your
        Personal Data. For the avoidance of doubt, We will only use your
        Personal Data for the purposes described in this Privacy Policy, and in
        no case, We will provide access or share your Personal Data with any
        third party, except with the relevant persons set forth in this Privacy
        Policy.
      </Paragraph>
      <Paragraph>
      ...
      <ol>
        ...
        <li>
          ...
          <Paragraph>
            ...
            <ListNoIndent type="a">
              ...
              <li>
                <u>Correction of your Personal Data:</u> YOU can request that We
                correct any information that we hold about YOU if it is
              ...
              <li>
                ...
                Data where YOU have exercised your right to object to processing
                (see below).
              </li>
              <li>
                ...
                particular situation, which makes YOU want to object to the
              ...
              <li>
                <u>Restriction of processing of your Personal Data:</u> enables
              ...
              <li>
                <u>Withdraw of consent:</u> This right only exists where we are
                relying on consent to process your Personal Data. If YOU
        ...
        <li>
          ...
          <Paragraph>
            After we have analysed your request, We will reply to your complaint
            as prompt as possible, always trying to provide the best possible
            assistance. Notwithstanding, if YOU feel that your complaint has not
            been adequately resolved, please note that if YOU are in the EU the
            GDPR gives YOU the right to contact your local data protection
        ...
        <li>
          ...
          <Paragraph>
            ...
            YOU with the Services, personalize content, remember information to
            help YOU efficiently access your account, analyse how the Services
            are used, diagnose service or technical problems, maintain security,
        ...
        <li>
          ...
          <Paragraph>
            ...
            Personal Data we may collect from YOU is described in the following
            table:
          </Paragraph>
          <table>
            <DataTableHead>
            ...
            <tbody>
              <TrLine>
                ...
                <TdRight>
                  First name, surname, maiden name, last name, username, date of
                  birth, gender, picture, signature, etc.
                </TdRight>
              </TrLine>
              <TrLine>
                <TdLeft>
              ...
              <TrLine>
                ...
                <TdRight>
                  ...
                  and other contributions on the Services.
                </TdRight>
              </TrLine>
              <TrLine>
                <TdLeft>
                ...
                <TdRight>
                  ...
                  parties and your communication preferences. If YOU correspond
                  with Us by email or messaging through the Services, we may
                  retain the content of such messages and our responses.
                </TdRight>
              </TrLine>
              <TrLine>
                <TdLeft>
                ...
                <TdRight>
                  ...
                  interests, based on your online activity.
                </TdRight>
              </TrLine>
              <TrLine>
                <TdLeft>
              ...
              <tr>
                ...
                <TdRight>
                  Health conditions from You, when accessing the questionnaire.
                </TdRight>
              </tr>
            </tbody>
          </table>
        ...
        <li>
          ...
          <Paragraph>
            Aggregated Data may be derived from your Personal Data, but once in
            aggregated form it will not constitute Personal Data as this data
            does not directly or indirectly reveal your identity. However, if we
            combine or connect Aggregated Data with your Personal Data, We can
            directly or indirectly identify YOU. In this sense, we will treat
        ...
        <li>
          ...
          <Paragraph>
            ...
            customer support; to send YOU Newsletters or other communication in
            which YOU can be interested on; to perform research and analysis
            about your use of the Services; to develop, display, and track
            Content and advertising tailored to your interests on the Services
            and other sites; website or mobile application analytics; to
            diagnose or fix technology problems; to automatically update the
            Services on your device; to verify your identify and prevent fraud
          ...
          <Paragraph>
            ...
            will not affect any processing that has already taken place) and YOU
            can contact Us to the email{" "}
            <TermsLink href="mailto:legal@fightpandemics.com">
              legal@fightpandemics.com
            </TermsLink>{" "}
            ...
            purposes for which we may use your Personal Data are the following:
            <ListNoIndent type="a">
              <li>
                <u>Maintenance of the Services and Customer Support:</u> we will
                process your data in order to deliver the Services YOU have
                requested, including, for example, YOU joining as a user,
              ...
              <li>
                <u>Research and development:</u> WE will use your information in
                order to understand your usage, activity patterns, areas for
                additional features and improvement of the Services and other
                insights.
              </li>
              <li>
                <u>Communicating with users about the Services:</u> to send
                communications via email and within the Services, including, for
                example, responding to your comments, questions and requests,
                sending Newsletters, informing about our events, etc.
              </li>
              <li>
                <u>
        ...
        <li>
          ...
          <Paragraph>
            WE may not be able to perform the contract We have or are trying to
            enter into with YOU.
          </Paragraph>
        </li>
        <li>
          ...
          <Paragraph>
            ...
            <ListNoIndent type="a">
              <li>
                ...
                that perform amongst others, to process maintenance and other IT
                services, marketing and communication, accounting, finance,
                legal and audit and other business operations for Us, and in
                order to be able to provide our service.
              </li>
              <li>
                <u>
                  Law enforcement agency, court, regulator, government authority
                  or other third party with compelling authority:
                </u>{" "}
        ...
        <li>
          ...
          <Paragraph>
            ...
            with YOU has come to an end, We will retain your personal data for a
            period of time that enables Us to:
            <ListNoIndent tyoe="a">
              <li>
          ...
          <Paragraph>
            We will delete your personal data when it is no longer required for
            these purposes. If there is any information that We are unable, for
            technical reasons, to delete entirely from our systems, We will put
            in place appropriate measures to prevent any further processing or
            use of the data.
          </Paragraph>
        </li>
        <li>
          ...
          <Paragraph>
            ...
            Notwithstanding, your Personal Data will be stored, processed in the
            EU.
          </Paragraph>
        </li>
        <li>
          ...
          <Paragraph>
            ...
            compromised as a result of such breach of security, the Company will
            promptly notify by e-mail to those persons whose personal
