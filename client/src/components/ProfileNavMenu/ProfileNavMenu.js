...
const Arrow = () => {
    return (
        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path className="path1" stroke= {colors.royalBlue} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <path className="path2" stroke= {colors.royalBlue} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    );
}
