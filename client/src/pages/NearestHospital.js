    ...
    if(isMobile) {
      return (
        ...
        return (
          <div>
            <CheckSymptomsBox />
            {page === "nearest-hospital" ? <HealthFacilities /> : <ConfirmedCases />}
         </div>
        )
      }
    }
  ...
  return (
    <NearestHospitalContainer>
       ...
       <NearestHospitalSideBar>
          <Sidebar>
          <ul>
             <li><NavLink onClick={(pageName) => setCurrentPage("nearest-hospital")} activeStyle={page === "nearest-hospital" ? ActiveLinkStyles : null} to="#">Health Facilities</NavLink></li>
             <li>
               <NavLink
               onClick={(pageName) => setCurrentPage("confirmed-cases")}
               activeStyle={page === "confirmed-cases" ? ActiveLinkStyles : null}
               to="#">
               Confirmed Cases
               </NavLink>
             </li>
