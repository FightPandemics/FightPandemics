...
const Application = ({ isAuthenticated }) => {
    ...
    //             {// TABS
    //             }
    //             <ProfileTabs defaultActiveKey="members">
    ...
    return (
        <>
            <h1 style={{ "color": "red" }}>Dependency on User Story 7.1</h1>
        </>
    )
    // }
};

export default withUserContext(withOrganisationContext(Application));
