...
const nearestHospitalInActive = require("../assets/nearest-hospital-inactive.png");
const nearestHospitalActive = require("../assets/nearest-hospitalActive.png");
// const symptomsCheckInActive = require("../assets/covid19-symptoms-active.png");
const symptomsCheckActive = require("../assets/covid19-symptoms.svg");
const findHelpInActive = require("../assets/find-help-inactive.svg");
const findHelpActive = require("../assets/find-helpActive.svg");
    ...
    <div className="text-center">
      ...
      <OnboardingContainer style={{ display: "flex", flexWrap: "wrap" }}>
        <FlexChild>
          <ImageButton
            type="ghost"
            inactiveImg={nearestHospitalInActive}
            activeImg={nearestHospitalActive}
        ...
        <FlexChild>
          <ImageButton
            type="ghost"
            inactiveImg={symptomsCheckActive}
            activeImg={symptomsCheckActive}
        ...
        <FlexChild>
          <ImageButton
            type="ghost"
            inactiveImg={findHelpInActive}
            activeImg={findHelpActive}
