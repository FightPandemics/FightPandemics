  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      notification.success({
        message: t("profile.individual.passwordUpdateSuccess"),
      });
      setLoading(false);
    } catch (error) {
      setLoading(false);
      ...
      <EditLayout>
        ...
        <FormLayout>
          <OptionDiv>
            ...
            {usesPassword && (
              <CustomLink to="/edit-security" isSelected>
              ...
              <>
                <InputWrapper>
                  ...
                  <Input
                    ...
                    ref={register({
                      required:
                        t("profile.individual.currentPasswordRequired") + ".",
                    })}
                ...
                <InputWrapper>
                  ...
                  <Input
                    ...
                    ref={register({
                      ...
                      required:
                        t("profile.individual.newPasswordRequired") + ".",
                ...
                <CustomSubmitButton
                  ...
                  disabled={
                    ...
                    Object.values(getValues()).filter(Boolean).length < 3
                  }
