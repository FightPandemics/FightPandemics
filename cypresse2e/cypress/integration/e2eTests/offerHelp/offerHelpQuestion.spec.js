...
describe('Fight Pandemics Offer Help Questionnaire', () => {
    ...
    context('User goes to offer help question one page', () => {
        ...
        it('Offer Help Question One page contains answer options & checkboxes to select option/options for question one', () => {
            ...
            offerHelpQuestion.getCheckboxOne().should('be.visible').check({ force: true }).should('be.checked');
            offerHelpQuestion.getCheckboxTwo().should('be.visible').check({ force: true }).should('be.checked');
            offerHelpQuestion.getCheckboxThree().should('be.visible').check({ force: true }).should('be.checked');
        });
    ...
    context('User goes to offer help question 2', () => {
        ...
        it('Offer Help Question Two Page - Show Postings Link is visible and clickable', () => {
            ...
            offerHelpQuestion.getShowMePostLink().should('be.visible').contains(showMePostLink).click({ force: true });
        });
